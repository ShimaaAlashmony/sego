...
const navLinks = [
    ...
    },
    {
            ...
            page: 'specialization',
            nestedRoutes: true,
            comp: <ul className="absolute invisible duration-300 translate-y-32 opacity-0 top-12 group-hover:visible group-hover:opacity-100 group-hover:translate-y-0  bg-[#1f253a] p-4 rounded w-[250px]">
